...
[TestClass]
public class UlcerIndexBufferListTests : BufferListTestBase, ITestChainBufferList
{
    ...
    private static readonly IReadOnlyList<UlcerIndexResult> series
       = Bars.ToUlcerIndex(lookbackPeriods);
    ...
    {
        UlcerIndexList sut = Bars.ToUlcerIndexList(lookbackPeriods);
    ...
    {
        UlcerIndexList sut = new(lookbackPeriods, Bars);
