...
[TestClass]
public class CmoBufferListTests : BufferListTestBase, ITestChainBufferList
{
    ...
    {
        CmoList sut = Bars.ToCmoList(lookbackPeriods);
    ...
    {
        CmoList sut = new(lookbackPeriods, Bars);
