...
[TestClass]
public class SmmaBufferListTests : BufferListTestBase, ITestChainBufferList
{
    ...
    {
        SmmaList sut = Bars.ToSmmaList(lookbackPeriods);
    ...
    {
        SmmaList sut = new(lookbackPeriods, Bars);
