...
public static partial class Pvo
{
    ...
    internal static readonly IndicatorListing CommonListing =
        new CatalogListingBuilder()
            ...
            .AddResult(nameof(PvoResult.Pvo), "PVO", "Pvo", ResultType.Default, isReusable: true)
            .AddResult(nameof(PvoResult.Signal), "Signal", "Pvo", ResultType.Default)
            .AddResult(nameof(PvoResult.Histogram), "Histogram", "Pvo", ResultType.Default)
            .Build();
