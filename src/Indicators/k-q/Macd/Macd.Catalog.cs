...
public static partial class Macd
{
    ...
    internal static readonly IndicatorListing CommonListing =
        new CatalogListingBuilder()
            ...
            .AddResult(nameof(MacdResult.Macd), "MACD", "Macd", ResultType.Default, isReusable: true)
            .AddResult(nameof(MacdResult.Signal), "Signal", "Macd", ResultType.Default)
            .AddResult(nameof(MacdResult.Histogram), "Histogram", "Macd", ResultType.Bar)
            .Build();
